...
## Current product branch: desktop 2.2.66 / shared firmware 0.8.1

The 2.2.66 Windows/macOS product uses the XIAO nRF52840 Sense LSM6DS3TR-C hardware
...
is not used as a fallback. The desktop identifies Windows or macOS automatically
...
acknowledges reception in bounded windows and
