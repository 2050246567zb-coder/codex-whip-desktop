...
## Current: desktop 2.2.57 / firmware 0.7.3

Product 2.2.57 uses the XIAO nRF52840 Sense LSM6DS3TR-C hardware
...
`RELEASE-2.2.57.md` for current build instructions and validation evidence.
